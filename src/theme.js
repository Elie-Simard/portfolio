...
/**
 * Material Dark Theme object.
 * @typedef {Object} MaterialDarkTheme
 * @property {string} body - The background color of the body.
 * @property {string} text - The color of the text.
 * @property {string} expTxtColor - The color of the expanded text.
 * @property {string} highlight - The highlight color.
 * @property {string} dark - The dark color.
 * @property {string} secondaryText - The color of the secondary text.
 * @property {string} imageHighlight - The highlight color for images.
 * @property {string} compImgHighlight - The highlight color for component images.
 * @property {string} jacketColor - The color of the jacket.
 * @property {string} headerColor - The color of the header.
 * @property {string} splashBg - The background color of the splash screen.
 */
